...
while ($fila = $resultado->fetch_assoc()) {
 ...
 ?>
  ...
  <td>
    <form action="../controllers/Partido_Controller.php" name ='EDIT'>
      ...
      <button class="botonResulPartidos" name = "action" value = "EDIT">Resultado</button>
    </form>
  </td>
